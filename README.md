...
## Examples
  ...
  * Yiddish date specifying year only (month defaults to current, shown on May 8): `[yidate year=1941]` דעם 8טן מײַ 1941
  ...
  * English date specifying year only (month defaults to current, shown on Apr 17): `[yidate year=1941]` Apr 17, 2023
